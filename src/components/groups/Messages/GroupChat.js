...
const GroupChat = ({ userId, groupId, allMembers }) => {
    return (
        <Modal.Dialog id="messageBox" style={{ display: 'box', borderRadius: '5px', padding: '0px auto', margin: '0px auto', paddingTop: '50px' }}>
            <Modal.Header style={{ background: darkBlue }} >
                <Modal.Title style={{ color: yellow }} >Group Chat</Modal.Title>
            </Modal.Header>

            <div id="messages" style={{ background: darkBlue, margin: '0px', padding: '0px', display: 'block' }} >
